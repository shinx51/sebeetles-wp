...
if ( defined('TC_DEV') && true === TC_DEV ) {
    require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-0-init-base.php' );
}

add_action('hu_hueman_loaded', 'ha_load_skop_options');
function ha_load_skop_options() {
    if ( defined('TC_DEV') && true === TC_DEV ) {
        require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-options-base.php' );
        require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-options-front-end-value.php' );
        require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-options-preview-value.php' );
        require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-options-x-final.php' );
    }
    HA_SKOP_OPT();
}
...
if ( HU_AD() -> ha_is_customizing() ) {
    if ( defined('TC_DEV') && true === TC_DEV ) {
        require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-customize-register.php' );
    }
...
if ( HU_AD() -> ha_is_customize_preview_frame() ) {
    if ( defined('TC_DEV') && true === TC_DEV ) {
        require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-customize-preview.php' );
    }
    new HA_Skop_Cust_Prev();
}
function ha_load_skop_ajax() {
    if ( defined('TC_DEV') && true === TC_DEV ) {
        require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-ajax-changeset-base.php' );
        require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-ajax-changeset-publish.php' );
        require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-ajax-changeset-save.php' );
        require_once( HA_BASE_PATH . 'inc/skop/_dev/skop-ajax-reset.php' );
    }
    new HA_Skop_Chset_Reset();
}
if ( defined('TC_DEV') && true === TC_DEV ) {
    if ( apply_filters('ha_print_skope_logs' , true ) ) {
        require_once( HA_BASE_PATH . 'inc/skop/_dev/_dev_skop-logs.php' );
